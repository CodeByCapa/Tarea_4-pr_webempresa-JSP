...
public class Empleado  extends Persona{
    ...
    DefaultTableModel tabla = new DefaultTableModel();
     ...
     cn = new Conexion();
     cn.abrir_conexion();
      String query = "select e.id_empleado as id, e.codigo, e.nombres, e.apellidos, e.direccion, e.telefono, e.fecha_nacimiento,p.puesto,p.id_puesto from db_empresa.empleados as e inner join db_empresa.puestos as p on e.id_puesto = p.id_puesto;";
