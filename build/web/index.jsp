    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="sr_empleado" method="post" class="form-group">
                ...
                <br>
                <button name="btn_agregar" id="btn_agregar" value="agregar" class="btn btn-primary"><i class="bi bi-cloud-upload-fill"></i> Agregar</button>
                <button name="btn_modificar" id="btn_modificar"  value="modificar" class="btn btn-warning"><i class="bi bi-arrow-repeat"></i> Modificar</button>
                <button name="btn_eliminar" id="btn_eliminar"  value="eliminar"  class="btn btn-danger" onclick="javascript:if(!confirm('¿Desea Eliminar?'))return false" ><i class="bi bi-trash3-fill"></i> Eliminar</button>
            </form>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-bs-dismiss="modal"><i class="bi bi-fire"></i> Cerrar</button>
        <button type="button"  class="btn btn-success"><i class="bi bi-floppy-fill"></i>
 Guardar</button>
      </div>
    </div>
  </div>
